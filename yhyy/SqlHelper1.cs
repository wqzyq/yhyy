...
namespace yhyy
{
    ...
    /// 不允许实例化，在应用时直接调用即可
    /// </summary>
    public abstract class SqlHelper1
    {
        /// <summary>
        /// 数据库连接字符串
        /// </summary>
        ...
        /// <param name="commandParameters">以数组形式提供SqlCommand命令中用到的参数列表</param>
        /// <returns>return a dataset</returns>
        public static DataSet ExecuteDataSetText(CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
        ...
        {
            return ExecuteDataSetText(cmdText, commandParameters).Tables[0];
        }

        /// <summary>
        /// 可选类型通过SQL或存储过程语句得到表格
        /// </summary>
        /// <param name="cmdText"></param>
        /// <param name="commandParameters"></param>
        /// <returns></returns>
        ...
        {
            return ExecuteDataSetText(cmdType, cmdText, commandParameters).Tables[0];
        }
        ...
        {
            return ExecuteScalar(SqlHelper1.connectionString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(SqlHelper1.connectionString, CommandType.StoredProcedure, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(SqlHelper1.connectionString, CommandType.Text, cmdText, commandParameters);
        }
